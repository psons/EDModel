 ...
 */
public class EffortDomain: Codable, CustomStringConvertible {
    public static let defaultGSlot = 0
    var name = ""
    public var todoMaxTasks = defaultMaxTasks
    var goals: [Goal] = []
    ...
    public init(name: String = "UNKNOWN", todoMaxTasks: Int = defaultMaxTasks) {
    ...
    public func addGoal(goal: Goal) -> Int {
